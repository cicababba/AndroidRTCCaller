...
public class RtcActivity extends Activity implements WebRtcClient.RtcListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        idContainer = findViewById(R.id.streamID);
        Button callButton = findViewById(R.id.callButton);
        callButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               try {
                   String remoteId = idContainer.getText().toString();
                   client.sendMessage(remoteId, "init", new JSONObject());
               } catch (Exception e) {
...
//        }
    ...
    public void startCam() {
        ...
        if (PermissionChecker.hasPermissions(this, RequiredPermissions)) {
            ...
            try {
                client.start("inizializzo lo stream");

                //client.sendMessage("T2rvtMbwjv2KywPwAAA4", "init", new JSONObject());
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void onAddRemoteStream(MediaStream remoteStream, int endPoint) {
        Log.i("ON ADD REMOTE STREAM", remoteStream.toString());
